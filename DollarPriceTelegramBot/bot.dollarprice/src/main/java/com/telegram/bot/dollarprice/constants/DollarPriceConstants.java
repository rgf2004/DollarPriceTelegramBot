package com.telegram.bot.dollarprice.constants;
...
public class DollarPriceConstants {
	...
	public static final String BANK_KEYWORD_LABEL = "bank_keyword_label";
	public static final String BUY_KEYWORD_LABEL = "buy_keyword_label";
	public static final String SELL_KEYWORD_LABEL = "sell_keyword_label";
	
	public static final String BEST_SELL_STRING = "best_sell_string";
	public static final String BEST_BUY_STRING = "best_buy_string";
	
	public static final String HTML_START_PART_KEY = "html_start_part";
	public static final String HTML_CONTENT_PART_KEY = "html_content_part";
